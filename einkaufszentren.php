...
<head>
    ...
    <title>CentralWorld</title>
</head>
<body>

<?php
// Informationen über CentralWorld
$einkaufszentrumName = "CentralWorld";
$standort = "Herz von Bangkoks Geschäftsviertel Ratchaprasong";
$beschreibung = "Eines der größten Einkaufszentren in Südostasien";

// Allgemeine Merkmale
$einkaufen = "CentralWorld beherbergt eine breite Palette von Einzelhandelsgeschäften, darunter internationale und lokale Marken, Modeboutiquen, Elektronikgeschäfte und vieles mehr.";
$unterhaltung = "Der Komplex bietet Unterhaltungsmöglichkeiten wie ein Kino, eine Bowlingbahn und andere Freizeiteinrichtungen.";
$essenTrinken = "Zahlreiche Restaurants und Lebensmittelgeschäfte bieten eine Vielzahl von Gerichten für unterschiedliche Geschmäcker und Vorlieben an.";
$veranstaltungen = "In CentralWorld finden häufig Veranstaltungen, Ausstellungen und festliche Feiern statt, vor allem während großer Feiertage und Festivals.";

// Standortinformationen
$beliebteSehenswuerdigkeiten = "In der Nähe beliebter Sehenswürdigkeiten wie dem Erawan-Schrein, dem Siam Paragon und dem MBK Center";
